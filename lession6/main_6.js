...
if (salary <= 0) {
  ...
  console.log(
    ` Số tiền nhận được sau khi đóng thuế thu nhập là: ${salary * (1 - 0.05)}`
  );
} else if (salary > 16000000 && salary <= 21000000) {
  console.log(
    ` Số tiền nhận được sau khi đóng thuế thu nhập là: ${salary * (1 - 0.1)}`
  );
} else if (salary > 21000000 && salary <= 26000000) {
  console.log(
    ` Số tiền nhận được sau khi đóng thuế thu nhập là: ${salary * (1 - 0.15)}`
  );
} else if (salary > 26000000 && salary <= 31000000) {
  console.log(
    ` Số tiền nhận được saau khi đóng thuế thu nhập là: ${salary * (1 - 0.2)}`
  );
} else if (salary > 31000000) {
  console.log(
    ` Số tiền nhận được sau khi đóng thuế thu nhập là: ${salary * (1 - 0.35)}`
  );
}
